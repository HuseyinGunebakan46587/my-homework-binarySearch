...
int main() {
    ...
    if (index != -1) {
        std::cout << "Binary search (first). Element found at index in vector: " << index << std::endl;
    }
    else {
    ...
    if (index != -1) {
        std::cout << "Binary search. Element found at index in array: " << index << std::endl;
    }
    else {
    ...
    if (index != -1) {
        std::cout << "Binary search (first). Element found at index in array: " << index << std::endl;
    }
    else {
